...
class Dao extends DaoBase {
    ...
    public async updateGoodsInfo(goods_id: string | number, opts: any) {
    ...
    public async findGoodsList(opts: any) {
    ...
    public async findGoodsDetail(id: string | number) {
